...
/**
 * @file
 * Contains \Drupal\import_node\Form\ImportForm.
 */
namespace Drupal\import_node\Form;
...
class ImportForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $csv_file = $form_state->getValue('import_node');
    ...
    foreach($data as $row) {
      $operations[] = ['\Drupal\import_node\addImportContent::addImportContentItem', [$row]];
    }
    ...
    $batch = array(
      ...
      'finished' => '\Drupal\import_node\addImportContent::addImportContentItemCallback',
    );
    batch_set($batch);
  }
